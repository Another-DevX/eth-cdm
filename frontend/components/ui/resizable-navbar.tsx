...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto mt-4 hidden w-full max-w-[95vw] flex-row items-center justify-between self-start rounded-full bg-white/80 dark:bg-neutral-950/80 px-6 py-3 lg:flex border border-purple-500/10",
        className,
      )}
    >
      {children}
